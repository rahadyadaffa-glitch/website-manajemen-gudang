<x-app-layout>
    ...
    <div
        ...
        <div>
            ...
            <p class="text-on-surface-variant mt-2 border-l-4 border-amber-500 pl-4 bg-surface-container-high/50 py-2 w-fit italic">
                Perbarui informasi detail produk di sistem inventaris
            </p>
        </div>
    ...
    <div class="max-w-5xl mx-auto">
        <form action="{{ route('admin.products.update', array_merge([$product], request()->only(['date', 'category_id']))) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="number" step="0.01" name="weight_value" value="{{ old('weight_value', $product->weight_value) }}"
                                    ...
                                    <div>
                                        ...
                                        <select name="weight_unit"
                                            ...
                                            <option value="gr" {{ old('weight_unit', $product->weight_unit) == 'gr' ? 'selected' : '' }}>GR</option>
                                            ...
                                            <option value="l" {{ old('weight_unit', $product->weight_unit) == 'l' ? 'selected' : '' }}>L</option>
