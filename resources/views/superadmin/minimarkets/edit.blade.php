    ...
    <x-slot name="header">
        <nav class="mb-4">
            <ol class="flex items-center space-x-2 text-sm text-gray-500">
                ...
                <li class="text-gray-900 font-medium">Edit Minimarket</li>
            </ol>
        </nav>
        <h1 class="text-3xl font-bold text-gray-900">Edit {{ $minimarket->name }}</h1>
    </x-slot>
            ...
            <form action="{{ route('superadmin.minimarkets.update', $minimarket) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="address" id="address" rows="3" required 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">{{ old('address', $minimarket->address) }}</textarea>
