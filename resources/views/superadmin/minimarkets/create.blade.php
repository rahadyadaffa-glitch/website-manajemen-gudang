        ...
        <div>
            <nav class="flex text-[10px] font-black uppercase tracking-widest text-stone-500 mb-2" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    <li><a href="{{ route('superadmin.minimarkets.index') }}" class="hover:text-amber-500 transition-colors">MINIMARKET</a></li>
                    <li><span class="mx-2">/</span></li>
                    <li class="text-amber-500 uppercase">TAMBAH BARU</li>
                </ol>
            </nav>
            <h1 class="font-headline-lg text-headline-lg text-amber-500 uppercase">TAMBAH MINIMARKET</h1>
            <p class="text-on-surface-variant mt-2 border-l-4 border-amber-500 pl-4 bg-surface-container-high/50 py-2 w-fit italic">
                Inisialisasi cabang minimarket baru dalam jaringan Voxel
            </p>
        </div>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-surface-container pixel-border p-6 md:p-10">
            <form action="{{ route('superadmin.minimarkets.store') }}" method="POST">
                ...
                <div class="mb-8">
                    <label for="phone" class="block text-[10px] font-black text-on-surface-variant uppercase tracking-widest mb-2">Nomor Telepon (Optional)</label>
