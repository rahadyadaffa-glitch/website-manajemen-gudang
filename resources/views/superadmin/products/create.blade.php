    ...
    <div
        ...
        <div>
            ...
            <p class="text-on-surface-variant mt-2 border-l-4 border-amber-500 pl-4 bg-surface-container-high/50 py-2 w-fit italic text-xs">
                Inisialisasi data master produk ke dalam sistem pusat
            </p>
        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="p-6 bg-amber-500/10 pixel-border border-2 border-amber-500/20">
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex-[2]">
                                        <div class="relative">
                                            <input type="number" id="pcs_per_dus_input" name="pcs_per_dus" value="{{ old('pcs_per_dus', 1) }}" required min="1"
                                            ...
                                            <span id="unit_label" class="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] font-black text-amber-500/50 uppercase">PCS</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 flex items-center gap-2 text-stone-500 italic text-[10px] font-bold">
                                    ...
                                    <span>Tentukan berapa banyak unit eceran dalam 1 <strong>DUS</strong>.</span>
                                </div>
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="3"
                                    class="w-full bg-background pixel-border border-2 border-stone-800 px-4 py-3 text-sm text-on-surface focus:outline-none focus:border-amber-500 transition-all">{{ old('description') }}</textarea>
